...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{%
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.6]{../processed/NRT/small/checks/120-0.02/fixedfilters/5f/plots/mrt.png}
            \caption*{}
        \end{minipage}
        \hspace{0.08\textwidth}
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.6]{../processed/NRT/small/checks/120-0.02/fixedfilters/20f/plots/mrt.png}
            \caption*{}
        \end{minipage}
    }
    ...
    \makebox[\textwidth][c]{%
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.6]{../processed/NRT/small/checks/120-0.02/fixedfilters/100f/plots/mrt.png}
            \caption*{}
        \end{minipage}
        \hspace{0.08\textwidth}
        \begin{minipage}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.6]{../processed/NRT/small/checks/120-0.02/fixedfilters/1000f/plots/mrt.png}
            \caption*{}
        \end{minipage}
    }
