...
\begin{itemize}
  \item Con escalado cambiado al nivel de $\mu$s
  \item No se perdían alerts. Sin embargo estaba tendiéndose a un escenario de high stress al hacer tanto escalado
\end{itemize}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|c|}
    \hline
    Execution & Scaled   & Num. filters & Num. cores & Num. alerts\\ \hline
    RT & 10' & 1 & 1, 4, 16 & 462\\ \hline
    RT & 10' & 40 & 1, 4, 16 & 462\\\hline
    RT & 10' & 2000 & 1, 4, 16 & 462\\ \hline
  \end{tabular}
  \caption{Different experimental setups results}
  \label{table:small-results}
  \end{table}
