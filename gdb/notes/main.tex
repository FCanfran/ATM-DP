...
\begin{enumerate}
    \item \textbf{Creation of the ATM subset}: Among all the ATMs of the stable bank database we create a subset of ATMs, so that all the regular transactions generated for this card take place in ATMs of this subset. 
