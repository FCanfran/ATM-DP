...
To do the generation of the synthetic set of transactions we provide the Python program \texttt{transactionGenerator.py}. On it we need to enter some parameters needed to customise the generation of the set of transactions.
...
\begin{itemize}
    ...
    $X_i \sim \text{Exp}(\lambda)$. They represent the time elapsed between two of these events, e.g. $X_2$ To do the generation of the synthetic set of transactions we provide the Python program \texttt{transactionGenerator.py}. On it we need to enter some parameters needed to customise the generation of the set of transactions.avoid introducing anomalous undesired scenarios, we have to impose 
