...
plot_answer_trace_edit(traces, "dp", COLORS)
...
plot_performance_of_approaches_with_dieft_edit(exp1, "dp", COLORS)
...
plot_continuous_efficiency_with_diefk_edit(exp2, "dp", COLORS)
